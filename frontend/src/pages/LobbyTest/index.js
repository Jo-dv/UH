...
const RoomTest = () => {
  // const [mySessionId, setMySessionId] = useSate("E201");
  // const [myUserName, setMyUserName] = useSate(
  //   "ㅇㅇ" + Math.floor(Math.random() * 100)
  // );
  // const [session,SetSession] = useSate(undefined)
  // const [mainStreamManager,SetMainStreamManager] = useSate(undefined)
  ...
  const joinSession = async () => {
    console.log("조인세션 눌러짐");
    // --- 1) Get an OpenVidu object ---

    OV = new OpenVidu();
    // --- 2) Init a session ---
    let tmpSession = OV.initSession();
    // await setData({ ...data, session: cnt });

    var mySession = tmpSession;
    ...
    getToken().then((token) => {
      ...
      mySession
        ...
        .then(async () => {
          ...
          console("bbbbbbbbbbbbbbbbbbbbbbbbb");
          ...
          console("asdasdaaaaaaaaaaaaaaaaaaa");
        })
        .catch((error) => {
          console.log(
          ...
          <div className="grid grid-cols-4 h-screen-40">
            ...
            <div className="grid grid-cols-1  gap-2">
              <div className="col-span-3">
                {/* <Chat myUserName={data.myUserName} session={data.session} /> */}
              </div>
